...
| senior  | claude-opus-4-8                | 87.6%              | 64.3%         | 3+ files, cross-layer changes, architecture, migration, complex edges, self-verification | High-level intent + architectural constraint + cross-cutting concerns + acceptance criterion. Opus 4.8 designs the solution; do not prescribe low-level code. |
