...
[//]: # ()
[//]: # (Spot-checked against 2.1.259 on 2026-09-03: the OWASP string the security note below)
[//]: # (turns on is still in the shipped bundle, so that argument still holds. The other two)
[//]: # (layers were NOT re-audited at 2.1.259; treat every other claim here as pinned to 2.1.220.)
[//]: # ()
...
[//]: # (duplicate: the built-in system prompt carries the same mandate, but inside a block that)
[//]: # (renders conditionally on the output style keeping coding instructions. Cutting one bullet)
[//]: # (of that block while defending another on conditional-render grounds would make this file)
[//]: # (argue both ways.)
[//]: # ()
